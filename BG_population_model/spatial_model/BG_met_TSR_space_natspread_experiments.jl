...
fec_max = 60.0;
fec0 = 4.0;
fec_cost = 0.9;  # when fec0 = 5 and fec_cost = 0.8 fecundity is fec_max*0.62 at g = 5
dd_fec = 0.15;
base_sur = 10.0; 
herb_effect = 14.0; # herbicide kills 98% of suceptable plants
g_prot = 2.0; # when g = 5 survival will be 0.99 * base_sur (basically same as TSR). 
pro_exposed = 0.8;
seed_sur = 0.45;
germ_prob = 0.52;
resist_G = ["RR", "Rr"];
...
TSR_adv_max = maximum(hcat(TSR_adv_ne_empty, TSR_adv_ne_full, TSR_adv_nn_empty, 
  TSR_adv_en_full, TSR_adv_ee_empty, TSR_adv_ee_full));
  
TSR_adv_min = minimum(hcat(TSR_adv_ne_empty, TSR_adv_ne_full, TSR_adv_nn_empty, 
  TSR_adv_en_full, TSR_adv_ee_empty, TSR_adv_ee_full));
...
TSR_rel_fec_max = maximum(hcat(TSR_rel_fec_ne_empty, TSR_rel_fec_ne_full, TSR_rel_fec_nn_empty, 
  TSR_rel_fec_en_full, TSR_rel_fec_ee_empty, TSR_rel_fec_ee_full));
  
TSR_rel_fec_min = minimum(hcat(TSR_rel_fec_ne_empty, TSR_rel_fec_ne_full, TSR_rel_fec_nn_empty, 
  TSR_rel_fec_en_full, TSR_rel_fec_ee_empty, TSR_rel_fec_ee_full));
#
###################################################################################################
# make the plots
...
dualchan_heatmap_grid(colmat_ee_empty, colmat_ee_full, colmat_ne_empty, colmat_ne_full, 
  colmat_en_empty, colmat_en_full, 1.9, 1.0, TSR_adv_min, TSR_adv_max, "TSR reproductive advantage", 
