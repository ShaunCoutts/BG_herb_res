...
\begin{longtable}{c c c p{5cm} p{4cm}}
	...
	$Y_D$ & \makecell[t]{\pounds$\cdot$plant$\cdot$\\$ha^{-1}$} & 0.0002--0.006 & reduction in yield caused by each \textit{A. myosuroides}. & 95\% confidence interval from fitted yield function, see \nameref{app:Re_fun}. \\
