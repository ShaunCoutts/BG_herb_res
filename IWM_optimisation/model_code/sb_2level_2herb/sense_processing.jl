...
code_loc = "/Users/shauncoutts/Dropbox/projects/MHR_blackgrass/IWM_optimisation/model_code/sb_2level_2herb"
data_loc = "/Users/shauncoutts/Dropbox/projects/MHR_blackgrass/IWM_optimisation/outputs/GA_2level_sb_out/data_out"
...
# take the summary from the first 10 years to avoid the end, and managment relevent
sense_sum = make_sum_sense(sol_sweep, 10);

# write the results to file
cd(data_loc)
CSV.write("sense_summary.csv", sense_sum);

# make a summary that hold the action seqences
sense_sum_as = make_ts_sense(sol_sweep, 20);

cd(data_loc)
CSV.write("sense_summary_ts.csv", sense_sum_as);
